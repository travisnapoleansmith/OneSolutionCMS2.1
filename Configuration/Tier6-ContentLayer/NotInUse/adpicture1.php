<?php
	...
	if ($printpreview == FALSE) {
		...
		$picturedatabase['AdPicture1'] = 'AdPicture1';
		
		$databases = &$GLOBALS['Tier6Databases'];
		$credentaillogonarray = $GLOBALS['credentaillogonarray'];
		
		$picture = new XhtmlPicture($picturedatabase, $databases);
		$picture->setDatabaseAll ($credentaillogonarray[0], $credentaillogonarray[1], $credentaillogonarray[2], $credentaillogonarray[3], 'AdPicture1');
