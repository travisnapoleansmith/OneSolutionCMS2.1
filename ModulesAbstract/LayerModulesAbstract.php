			...
			if (file_exists($Filename)) {
				...
				foreach ($File as $FileContent) {
					...
					if (file_exists($FileContent)) {
						...
						system ($SqlFileCommand, $ReturnStatus);
						if ($ReturnStatus > 0) {
							switch($ReturnStatus) {
								case 1:
									$ReturnArray[$FileContent] = 'General Error';
									break;
								case 2:
									$ReturnArray[$FileContent] = 'Misuse Of Shell Builins';
									break;
								case 126:
									$ReturnArray[$FileContent] = 'Command Invoked Cannot Execute';
									break;
								case 127:
									$ReturnArray[$FileContent] = 'Command Not Found';
									break;
								case 128:
									$ReturnArray[$FileContent] = 'Invalid Argument To Exit';
									break;
								case 130:
									$ReturnArray[$FileContent] = 'Script Terminated By Control-C';
									break;
							}
						}
					} else {
						$ReturnArray[$FileContent] = 'File Does Not Exist';
					}
				}
