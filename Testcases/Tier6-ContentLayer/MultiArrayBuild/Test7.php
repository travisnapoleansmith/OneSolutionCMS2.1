<?php
	...
	*/
	...
	// TEST CASE 7 for Method MultiArrayBuild
	// $Tier6Databases -> MultiArrayBuild(array $Start, $StartKey, $ConditionalKey, $StartNumber, array $Source);
	// Tests out with sorting an unordered list no order number defined with 1 unlisted root field and 1 unlisted non-root field.
