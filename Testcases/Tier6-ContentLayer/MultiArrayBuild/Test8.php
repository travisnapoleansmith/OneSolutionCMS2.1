<?php
	...
	*/
	...
	// TEST CASE 8 for Method MultiArrayBuild
	// $Tier6Databases -> MultiArrayBuild(array $Start, $StartKey, $ConditionalKey, $StartNumber, array $Source);
	// Tests out with sorting unordered list 1 malformed order number with 1 unlisted root field and 1 unlisted non-root field.
