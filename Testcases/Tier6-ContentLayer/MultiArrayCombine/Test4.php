<?
	// TEST CASE 4 for Method MultiArrayCombine
	// $Tier6Databases -> MultiArrayCombine($StartNumber, array $Source);
	// Tests out a combine mulitdimensional array into a single dimensional array with 2 deep using an integer that is not in the array Start Number.
	// Should return NULL;
