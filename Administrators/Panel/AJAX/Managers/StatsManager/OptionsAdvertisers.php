	...
	if ($RefererPage == $ServerLocation . "/Administrators/Panel/Managers/StatsManager/StatsManager.php") {
		if ($_SERVER['HTTP_X_REQUESTED_WITH'] === 'XMLHttpRequest') {
			...
			if ($AdPanel != NULL) {
				...
				$Tier2Databases->createDatabaseTable($AdPanel);
				$Tier2Databases->Connect($AdPanel);
				$Tier2Databases->pass ($AdPanel, "setEntireTable", array());
				$AdPanelListings= $Tier2Databases->pass ($AdPanel, "getEntireTable", array());
				$Tier2Databases->Disconnect($AdPanel);
