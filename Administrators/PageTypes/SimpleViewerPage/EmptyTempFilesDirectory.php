<?php
	...
	*/
	...
	$Page->text("One Solution CMS - Empty SimpleViewer Galleries Temp Files Directory Utility");
	...
	$Page->text('Welcome To One Solution CMS Empty SimplyViewer Galleries Temp Files Directory Utility');
