<?php
	...
	*/
	...
	$Page->text("One Solution CMS - Empty SimpleViewer Galleries Upload Directory Utility");
	...
	$Page->text('Welcome To One Solution CMS Empty SimpleViewer Galleries Upload Directory Utility');
