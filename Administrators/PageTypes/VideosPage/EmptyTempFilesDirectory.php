<?php
	...
	*/
	...
	$Page->text("One Solution CMS - Empty Videos Pages Temp Files Directory Utility");
	...
	$Page->text('Welcome To One Solution CMS Empty Videos Pages Temp Files Directory Utility');
