<?php
	...
	*/
	...
	if ($ReferPageID === 'PageID=180') {
		$LogPage = FALSE;
		
		if ($LogPage === TRUE) {
			$LogFile = "AddBlockQuotePage.txt";
			$LogFileHandle = fopen($LogFile, 'a');
			$FileInformation = 'Logging - Add Blockquote Page Script Loading - ' . date("F j, Y, g:i a") . "\n";
		...
		if ($hold) {
			...
			if ($LogPage === TRUE) {
				$LogFile = "AddBlockQuotePage.txt";
				$LogFileHandle = fopen($LogFile, 'a');
				$FileInformation = 'Logging - Add Blockquote Page Top Script - ' . $NewPageID . ' - ' . date("F j, Y, g:i a") . "\n";
				fwrite($LogFileHandle, $FileInformation);
			...
			if ($LogPage === TRUE) {
				$LogFile = "AddBlockQuotePage.txt";
				$LogFileHandle = fopen($LogFile, 'a');
				$FileInformation = 'Logging - Add Blockquote Page Bottom Script - ' . $NewPageID . ' - ' . date("F j, Y, g:i a") . "\n";
				fwrite($LogFileHandle, $FileInformation);
				fwrite($LogFileHandle, print_r($BlockquotePageCreatedPage, TRUE));
				fwrite($LogFileHandle, "\n---------------------------------------------\n\n");
				fclose($LogFileHandle);
			}
