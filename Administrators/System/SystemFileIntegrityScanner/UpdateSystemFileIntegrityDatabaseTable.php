<?php
	...
	*/
	...
	$DatabaseTableArray = $Integrity->createSystemFiles ($FileName);
	
	$Integrity->emptyDatabaseTable();
	$Integrity->createDatabaseTableArray($DatabaseTableArray);
	...
	$Page->text("One Solution CMS - Update System File Integrity Database Table");
	...
	$Page->text('Welcome To One Solution CMS Update System File Integrity Database Table Utility');
	$Page->endElement(); //ENDS H1


	$text = "System File Integrity Database Table has been updated. You can now use the System File Integrity Database Tool!";
