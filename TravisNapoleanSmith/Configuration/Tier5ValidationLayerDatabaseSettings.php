<?php
	...
	$Tier5Databases->createDatabaseTable('FormValidation');
	$Tier5Databases->createDatabaseTable('HtmlTags');
	...
	$Tier5Databases->createDatabaseTable('States');
	...
	$Tier5Databases->createDatabaseTable('Zipcodes');
