	...
	*/
	public function Connect () {
		if ($this->HostName == NULL | $this->User == NULL | $this->Password == NULL | $this->DatabaseName == NULL) {
			if (isset($GLOBALS['credentaillogonarray']) & $GLOBALS['ConnectionOverride'] === FALSE) {
		...
		if ($this->HostName == NULL | $this->User == NULL | $this->Password == NULL | $this->DatabaseName == NULL) {
			array_push($this->ErrorMessage,'Connect: HostName, User, Password, and DatabaseName none of them can be NULL!');
		...
		if (is_array($this->HostName) === TRUE | is_array($this->User) === TRUE | is_array($this->Password) === TRUE | is_array($this->DatabaseName) === TRUE) {
			array_push($this->ErrorMessage,'Connect: HostName, User, Password, and DatabaseName none of them can be an array!');
			$BackTrace = debug_backtrace(FALSE);
		...
		if (is_object($this->HostName) === TRUE | is_object($this->User) === TRUE | is_object($this->Password) === TRUE | is_object($this->DatabaseName) === TRUE) {
			array_push($this->ErrorMessage,'Connect: HostName, User, Password, and DatabaseName none of them can be an object!');
			$BackTrace = debug_backtrace(FALSE);
		...
		if (is_resource($this->HostName) === TRUE | is_resource($this->User) === TRUE | is_resource($this->Password) === TRUE | is_resource($this->DatabaseName) === TRUE) {
			array_push($this->ErrorMessage,'Connect: HostName, User, Password, and DatabaseName none of them can be a resource!');
			$BackTrace = debug_backtrace(FALSE);
