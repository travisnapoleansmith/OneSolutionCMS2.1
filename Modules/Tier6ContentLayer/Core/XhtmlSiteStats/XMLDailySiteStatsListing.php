<?php
	...
	*/
	...
	$SiteStatsDatabase['DatabaseTable2'] = 'SiteStatsDailyCurrent';
	...
	$SiteStats->setDatabaseAll ($credentaillogonarray[0], $credentaillogonarray[1], $credentaillogonarray[2], $credentaillogonarray[3], 'SiteStatsDaily');
